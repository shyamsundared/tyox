...
Your data contract is the heart of your application. It lives at [`schema.prisma`](schema.prisma) and describes your models:
...
| File | Purpose |
|---|---|
| [`schema.prisma`](schema.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`./db.ts`](./db.ts) | Database client — `import { db } from '././db'` |
| `./contract.json` | Compiled contract (generated) |
| `./contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`schema.prisma`](schema.prisma) to add or change models.
